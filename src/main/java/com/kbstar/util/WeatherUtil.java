...
public class WeatherUtil {
    public  static String getWeather1(String loc) throws Exception {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=twH0vrcPX8rQ916%2BVfO03xzoEWk9115Z50s2ysmhvdtBRIT%2BeXt82pEncDJQCAiwLL0WQ%2FHhql22rmyhmJKn7Q%3D%3D"); /*Service Key*/
...
//        System.out.println(sb.toString());
    ...
    public static Object getWeather3(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=IgMSt92A0G1nBaqBLH1cNHm%2FXoZW9N%2FEJEqLCa1HcXBhAIQjRLGoAlUMtCvdhdTgx9CJ1TRUKyHPKe0B6erRUA%3D%3D"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("startDt","UTF-8") + "=" + URLEncoder.encode("20230518", "UTF-8")); /*조회 기간 시작일(YYYYMMDD)*/
        urlBuilder.append("&" + URLEncoder.encode("startHh","UTF-8") + "=" + URLEncoder.encode("01", "UTF-8")); /*조회 기간 시작시(HH)*/
        urlBuilder.append("&" + URLEncoder.encode("endDt","UTF-8") + "=" + URLEncoder.encode("20230518", "UTF-8")); /*조회 기간 종료일(YYYYMMDD) (전일(D-1) 까지 제공)*/
